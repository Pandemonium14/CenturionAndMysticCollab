...
public class CenturionEnergyPanel implements CustomSavable<Integer> {
    ...
    private static final Texture LAYER_0 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer1.png"), true);
    private static final Texture LAYER_1 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer2.png"));
    private static final Texture LAYER_2 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer3.png"));
    private static final Texture LAYER_3 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer4.png"));
    private static final Texture LAYER_4 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer5.png"));
    private static final Texture LAYER_5 = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/layer6.png"), true);
    private static final Texture FLASH_TEXTURE = ImageMaster.loadImage(MainModfile.makeImagePath("energyOrbs/centurion/vfx.png"));
    ...
    public CenturionEnergyPanel(int baseEnergy) {
        CenturionEnergyPanel.baseEnergy = baseEnergy;
        //hitbox
    }
