...
public class PortraitHelper {
    ...
    private static final Texture attackMask = TexLoader.getTexture("CenturionAndMysticResources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture("CenturionAndMysticResources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture("CenturionAndMysticResources/images/masks/PowerMask.png");
